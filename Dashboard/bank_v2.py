...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Tabs([
            ...
            dbc.Tab([
                    html.Br(),
                    html.Iframe(srcDoc = corr_plot(), style = {'border-width': '0', 'width': '450px', 'height': '500px'}),
                    html.Iframe(id = 'distribution', style = {'border-width': '0', 'width': '450px', 'height': '500px'}),
                    html.Iframe(id = 'nc', style = {'border-width': '0', 'width': '450px', 'height': '500px'})
...
def nc_plot(numeric, categorical):
    chart = alt.Chart(df).mark_line().encode(
        ...
        y = 'count()',
        color= categorical+':N').properties(width = 250, height = 400)
